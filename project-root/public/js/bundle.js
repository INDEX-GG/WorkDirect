...
module.exports = JSON.parse("{\"posts\":[{\"title\":\"Находить респондентов для интервью\",\"href\":\"https://freelance.habr.com/tasks/375785\",\"discription\":\"Не указано\",\"price\":\"1000\",\"showPrice\":\"1 000 руб. за проект\",\"days\":\" ~ 6 часов назад \"},{\"title\":\"Создать сайт выполняющий роль личного кабинета клиента компании\",\"href\":\"https://freelance.habr.com/tasks/375783\",\"discription\":\"Не указано\",\"price\":\"30000\",\"showPrice\":\"30 000 руб. за проект\",\"days\":\" ~ 7 часов назад \"},{\"title\":\"Разработка REST API и поддержка проекта Node, React\",\"href\":\"https://freelance.habr.com/tasks/375779\",\"discription\":\"Не указано\",\"price\":\"30000\",\"showPrice\":\"30 000 руб. за проект\",\"days\":\" ~ 8 часов назад \"},{\"title\":\"Разработать мобильное приложение\",\"href\":\"https://freelance.habr.com/tasks/375769\",\"discription\":\"Не указано\",\"price\":\"300000\",\"showPrice\":\"300 000 руб. за проект\",\"days\":\" ~ 10 часов назад \"},{\"title\":\"Разработка одностраничного лендинга для салона красоты (маникюр + парикмахерская)\",\"href\":\"https://pchel.net/jobs/website-development/razrabotka-odnostranichnogo-lendinga-dlya-salona-krasotyi-manikyur-parikmaherskaya-1552820/\",\"discription\":\"\\n                                Необходимо разработать одностраничный лендинг для салона красоты (маникюр + парикмахерская). Просьба откликаться исполнителям с портфолио и опытом разработки подобных работ, указывайте в отклике стоимость работы и сроки.\\n                            \",\"price\":\"37500\",\"showPrice\":\" \\n                                                                            $500                                \",\"days\":\"1 месяц назад\"},{\"title\":\"Создать сайт выполняющий роль личного кабинета клиента компании\",\"href\":\"https://freelance.habr.com/tasks/375783\",\"discription\":\"Не указано\",\"price\":\"30000\",\"showPrice\":\"30 000 руб. за проект\",\"days\":\" ~ 7 часов назад \"},{\"title\":\"Разработка REST API и поддержка проекта Node, React\",\"href\":\"https://freelance.habr.com/tasks/375779\",\"discription\":\"Не указано\",\"price\":\"30000\",\"showPrice\":\"30 000 руб. за проект\",\"days\":\" ~ 8 часов назад \"},{\"title\":\"Разработать мобильное приложение\",\"href\":\"https://freelance.habr.com/tasks/375769\",\"discription\":\"Не указано\",\"price\":\"300000\",\"showPrice\":\"300 000 руб. за проект\",\"days\":\" ~ 10 часов назад \"},{\"title\":\"Разработка одностраничного лендинга для салона красоты (маникюр + парикмахерская)\",\"href\":\"https://pchel.net/jobs/website-development/razrabotka-odnostranichnogo-lendinga-dlya-salona-krasotyi-manikyur-parikmaherskaya-1552820/\",\"discription\":\"\\n                                Необходимо разработать одностраничный лендинг для салона красоты (маникюр + парикмахерская). Просьба откликаться исполнителям с портфолио и опытом разработки подобных работ, указывайте в отклике стоимость работы и сроки.\\n                            \",\"price\":\"37500\",\"showPrice\":\" \\n                                                                            $500                                \",\"days\":\"1 месяц назад\"},{\"title\":\"Создать сайт выполняющий роль личного кабинета клиента компании\",\"href\":\"https://freelance.habr.com/tasks/375783\",\"discription\":\"Не указано\",\"price\":\"30000\",\"showPrice\":\"30 000 руб. за проект\",\"days\":\" ~ 7 часов назад \"},{\"title\":\"Разработка REST API и поддержка проекта Node, React\",\"href\":\"https://freelance.habr.com/tasks/375779\",\"discription\":\"Не указано\",\"price\":\"30000\",\"showPrice\":\"30 000 руб. за проект\",\"days\":\" ~ 8 часов назад \"},{\"title\":\"Разработать мобильное приложение\",\"href\":\"https://freelance.habr.com/tasks/375769\",\"discription\":\"Не указано\",\"price\":\"300000\",\"showPrice\":\"300 000 руб. за проект\",\"days\":\" ~ 10 часов назад \"},{\"title\":\"Разработка одностраничного лендинга для салона красоты (маникюр + парикмахерская)\",\"href\":\"https://pchel.net/jobs/website-development/razrabotka-odnostranichnogo-lendinga-dlya-salona-krasotyi-manikyur-parikmaherskaya-1552820/\",\"discription\":\"\\n                                Необходимо разработать одностраничный лендинг для салона красоты (маникюр + парикмахерская). Просьба откликаться исполнителям с портфолио и опытом разработки подобных работ, указывайте в отклике стоимость работы и сроки.\\n                            \",\"price\":\"37500\",\"showPrice\":\" \\n                                                                            $500                                \",\"days\":\"1 месяц назад\"}]}");
...
/* harmony import */ var _Moduls_sort__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Moduls/sort */ "./src/js/Moduls/sort.js");
/* harmony import */ var _Moduls_sort__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_Moduls_sort__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _bd_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../bd.json */ "../bd.json");
var _bd_json__WEBPACK_IMPORTED_MODULE_2___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../../../bd.json */ "../bd.json", 1);
    ...
    <h2  class="preloader__text">Мы собираем заказы для вас</h2>`
        ...
        axios__WEBPACK_IMPORTED_MODULE_1___default.a.get("/tasks?request=" + query)
            .then((response) => {
                ...
                // console.log(data);
                Render(data);
                axios__WEBPACK_IMPORTED_MODULE_1___default.a.get("/tasks1?request=" + query)
                    .then((response) => {
                ...
                /*  axios.get("/tasks2?request=" + query)
                     .then((response) => {
                         ...
                         // console.log(data);
                         Render(data); */
                axios__WEBPACK_IMPORTED_MODULE_1___default.a.get("/tasks3?request=" + query)
                    .then((response) => {
                        data = [{ "posts": [...data[0].posts, ...response.data] }, formData]
                        // console.log(data);
                        Render(data);
